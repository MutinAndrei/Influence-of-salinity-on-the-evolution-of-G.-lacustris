...
p
# Collapse clades
nodes_to_collapse <- c(293, 247, 237, 224, 275, 186, 274)
...
# Print and save
ggsave("tree_final_clen_12092926.png", p, width = 14, height = 14, dpi = 300)
ggsave("tree_final_clean_12092926.svg", p_final, width = 14, height = 14, dpi = 300)
print(p_final)
...
# Save and print
ggsave("tree_full_path_highlight_12092926.png", p, width = 14, height = 14, dpi = 300)
ggsave("tree_full_path_highlight_12092926.svg", p, width = 14, height = 14, dpi = 300)
print(p)
...
# Build base tree with tip labels and node numbers
p <- ggtree(rerooted_tree_ape, layout = "circular", branch.length = "none") %<+% tip_data +
  geom_tree(color = "gray45", size = 2) +
  geom_tippoint(aes(color = group, x = x + 1), size = 6, alpha = 1) +
  geom_tiplab(
    size = 1.5,
    color = "black",
    offset = 0.5
...
# Save
ggsave("tree_with_tips_and_nodes.png", p, width = 16, height = 16, dpi = 300)
ggsave("tree_with_tips_and_nodes.svg", p, width = 16, height = 16, dpi = 300)